...
export const databaseMigrations: DatabaseMigration[] = [
  {
    ...
    statements: [
      ...
      `CREATE TABLE IF NOT EXISTS memory_houses (
        id TEXT PRIMARY KEY NOT NULL,
        project_id TEXT NOT NULL,
        name TEXT NOT NULL,
        notes TEXT,
      ...
      `CREATE TABLE IF NOT EXISTS memory_rooms (
        ...
        UNIQUE(project_id, id),
        FOREIGN KEY(project_id) REFERENCES moving_projects(id) ON DELETE CASCADE,
        FOREIGN KEY(project_id, house_id) REFERENCES memory_houses(project_id, id)
      )`,
      `CREATE TABLE IF NOT EXISTS memory_walls (
        id TEXT PRIMARY KEY NOT NULL,
        project_id TEXT NOT NULL,
        memory_room_id TEXT NOT NULL,
        name TEXT NOT NULL,
        notes TEXT,
        created_by TEXT NOT NULL,
        updated_by TEXT NOT NULL,
        ...
        UNIQUE(project_id, id),
        FOREIGN KEY(project_id) REFERENCES moving_projects(id) ON DELETE CASCADE,
        FOREIGN KEY(project_id, memory_room_id) REFERENCES memory_rooms(project_id, id)
      )`,
      ...
      'CREATE INDEX IF NOT EXISTS memory_houses_project_filter_idx ON memory_houses(project_id, updated_at)',
      'CREATE INDEX IF NOT EXISTS memory_rooms_project_filter_idx ON memory_rooms(project_id, house_id, updated_at)',
      'CREATE INDEX IF NOT EXISTS memory_walls_project_filter_idx ON memory_walls(project_id, memory_room_id)',
